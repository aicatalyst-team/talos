...
[**AdminUpdateImportedApiKey**](ApiKeysAPI.md#AdminUpdateImportedApiKey) | **Patch** /v2alpha1/admin/importedApiKeys/{imported_api_key.key_id} | Update Imported API Key
[**AdminUpdateIssuedApiKey**](ApiKeysAPI.md#AdminUpdateIssuedApiKey) | **Patch** /v2alpha1/admin/issuedApiKeys/{issued_api_key.key_id} | Update Issued API Key
...
> map[string]interface{} AdminDeleteImportedApiKey(ctx, keyId).Execute()
...
func main() {
	...
	// response from `AdminDeleteImportedApiKey`: map[string]interface{}
...
> map[string]interface{} AdminRevokeImportedApiKey(ctx, keyId).AdminRevokeImportedApiKeyBody(adminRevokeImportedApiKeyBody).Execute()
...
func main() {
	...
	// response from `AdminRevokeImportedApiKey`: map[string]interface{}
...
> map[string]interface{} AdminRevokeIssuedApiKey(ctx, keyId).AdminRevokeIssuedApiKeyBody(adminRevokeIssuedApiKeyBody).Execute()
...
func main() {
	...
	// response from `AdminRevokeIssuedApiKey`: map[string]interface{}
...
> ImportedApiKey AdminUpdateImportedApiKey(ctx, importedApiKeyKeyId).AdminUpdateImportedApiKeyRequest(adminUpdateImportedApiKeyRequest).UpdateMask(updateMask).Execute()
...
func main() {
	importedApiKeyKeyId := "importedApiKeyKeyId_example" // string | SHA-512/256 hash of credential
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ApiKeysAPI.AdminUpdateImportedApiKey(context.Background(), importedApiKeyKeyId).AdminUpdateImportedApiKeyRequest(adminUpdateImportedApiKeyRequest).UpdateMask(updateMask).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**importedApiKeyKeyId** | **string** | SHA-512/256 hash of credential | 
...
> IssuedApiKey AdminUpdateIssuedApiKey(ctx, issuedApiKeyKeyId).AdminUpdateIssuedApiKeyRequest(adminUpdateIssuedApiKeyRequest).UpdateMask(updateMask).Execute()
...
func main() {
	issuedApiKeyKeyId := "issuedApiKeyKeyId_example" // string | 
	adminUpdateIssuedApiKeyRequest := *openapiclient.NewAdminUpdateIssuedApiKeyRequest() // AdminUpdateIssuedApiKeyRequest | 
	updateMask := "updateMask_example" // string | The list of fields to update. See AIP-134. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ApiKeysAPI.AdminUpdateIssuedApiKey(context.Background(), issuedApiKeyKeyId).AdminUpdateIssuedApiKeyRequest(adminUpdateIssuedApiKeyRequest).UpdateMask(updateMask).Execute()
	if err != nil {
